...
class CurrencyViewHolder(itemView : View)  : RecyclerView.ViewHolder(itemView){
    ...
    private val namePlusCharCode = itemView.findViewById<TextView>(R.id.currency_name_and_char_code) //str input
    ...
    fun onBind(currency:MyCurrency, onItemListner: (myCurrency: MyCurrency) -> Unit) {
        ...
        val string = currency.name + "(" + currency.charCode + ")" // should relocate this to another place
